...
$.extend($.jgrid,{
	...
	del : {
	    caption: "Eliminar",
	    msg: "Deseja eliminar o(s) registo(s) sAlbumSetado(s)?",
	    bSubmit: "Eliminar",
	    bCancel: "Cancelar"
	},
	nav : {
		edittext: " ",
	    edittitle: "Modificar registo sAlbumSetado",
		addtext:" ",
	    addtitle: "Adicionar novo registo",
	    deltext: " ",
	    deltitle: "Eliminar registo sAlbumSetado",
	    searchtext: " ",
	    searchtitle: "Procurar",
	    refreshtext: "",
	    refreshtitle: "Actualizar",
	    alertcap: "Aviso",
	    alerttext: "Por favor, sAlbumSete um registo",
		viewtext: "",
