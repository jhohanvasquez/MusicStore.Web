...
namespace MusicStore.Web
{
    public class Util
    {
        ...
        public static string GetCurrentPassOperador()
        {
            string result = "";
            string filePath = System.Web.Hosting.HostingEnvironment.MapPath("~/Content/Save/OperadorP.resources");
        ...
        public static string GetCurrentUserOperador()
        {
            string result = "";
            string filePath = System.Web.Hosting.HostingEnvironment.MapPath("~/Content/Save/OperadorU.resources");
