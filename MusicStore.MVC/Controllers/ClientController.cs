...
namespace MusicStore.MVC.Controllers
{
    public class ClientController : Controller
    {
        ...
        public ActionResult Details(string id)
        {
            ...
            var Client = dbModel.ListClientorDetailFacade(id).FirstOrDefault();           
            if (Client == null)
            {
                return HttpNotFound();
            }
            Client oClientDto = new Client();
            oClientDto.Id = Client.Id;
            oClientDto.Name = Client.Name;
            oClientDto.Direction = Client.Direction;
            oClientDto.Mail = Client.Mail;
            oClientDto.Phone = Client.Phone;
            oClientDto.Photo = Client.Photo;
            ViewBag.ClientName = singleton.GetCurrentSingleton().ClientName;
            return View(oClientDto);
        }
