    ...
    */
    this.messages = {
      ...
      , type: {
          ...
          , urlstrict:  "Este valor debe ser una dirección url válida."
          , number:     "Solo número."
          , digits:     "Solo número."
          , dateIso:    "Formato incorrecto (DD-MM-AAAA)."
      ...
      , minlength:      "Este valor es demasiado corto. Debe tener %s digitos or mas."
      , maxlength:      "Este valor es demasiado largo. Debe tener %s digitos or menos."
      , rangelength:    "Esta longitud de valor no es válida. Debe estar entre %s y %s digitos."
      , mincheck:       "Debe sAlbumSetar al menos %s opciones."
      , maxcheck:       "Debe sAlbumSetar %s opciones o menos."
      , rangecheck:     "Debe sAlbumSetar entre %s y %s opciones."
