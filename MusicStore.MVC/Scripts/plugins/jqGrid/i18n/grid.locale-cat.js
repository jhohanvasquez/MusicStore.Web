...
$.extend($.jgrid,{
	...
	del : {
		caption: "Eliminar",
		msg: "¿Desitja eliminar els registres sAlbumSetats?",
		bSubmit: "Eliminar",
		bCancel: "Cancelar"
	},
	nav : {
		edittext: " ",
		edittitle: "Modificar fila sAlbumSetada",
		addtext:" ",
		addtitle: "Agregar nova fila",
		deltext: " ",
		deltitle: "Eliminar fila sAlbumSetada",
		searchtext: " ",
		searchtitle: "Cercar informació",
		refreshtext: "",
		refreshtitle: "Refrescar taula",
		alertcap: "Avís",
		alerttext: "SAlbumSeti una fila",
		viewtext: " ",
		viewtitle: "Veure fila sAlbumSetada"
	},
// setcolumns module
	col : {
